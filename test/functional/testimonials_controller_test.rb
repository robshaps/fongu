...
class TestimonialsControllerTest < ActionController::TestCase
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post :create, testimonial: { comments: @testimonial.comments, name: @testimonial.name, rating: @testimonial.rating }
    end
  ...
  test "should update testimonial" do
    put :update, id: @testimonial, testimonial: { comments: @testimonial.comments, name: @testimonial.name, rating: @testimonial.rating }
    assert_redirected_to testimonial_path(assigns(:testimonial))
  end
